...
const FinishRide = (props) => {
  return (
    <div>
      ...
      <h3 className="font-semibold text-2xl mb-5">Finish Ride</h3>
      ...
      <div className="flex justify-between items-center flex-col gap-3">
        ...
        <div className="w-full mt-6">
          <div className="flex w-full items-center gap-4">
            <Link
              to="/captain-home"
              className="w-full bg-black text-center text-white font-semibold p-3 rounded-xl text-lg mt-5 flex items-center justify-center"
              onClick={() => {}}
            >
              Finish Ride
